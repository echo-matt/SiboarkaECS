...
TestScene::TestScene(float screenW, float screenH) : inputSys(screenW, screenH), gravitySys(screenW, screenH), movementSys(screenW, screenH), placementSys(screenW, screenH, _grid)
{
    _screenH = screenH;
    _screenW = screenW;
}
